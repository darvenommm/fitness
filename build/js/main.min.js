...
var _disabled = require("./modules/custom-input/disabled");
var _video = require("./modules/description/video");
var _card = require("./modules/subscriptions/card");
var _slider = require("./modules/trainers/slider");
var _card2 = require("./modules/trainers/card");
var _tabs = require("./modules/faq/tabs");
var _slider2 = require("./modules/reviews/slider");
// ---------------------------------
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    window.form = form;
    form.init();
    (0, _disabled.addCustomInputDisabledHandlers)();
    (0, _video.addVideoHandlers)();
    (0, _initTabs.initTabs)();
    (0, _card.addButtonsClassByCardHover)();
    (0, _slider.initTrainersSlider)();
    (0, _card2.addHandlersForTrainersCard)();
    (0, _initAccordion.initAccordions)();
    (0, _tabs.addFAQTabsHandlers)();
    (0, _slider2.createReviewsSlider)();
  });
});
...
},{"./modules/accordion/init-accordion":3,"./modules/custom-input/disabled":4,"./modules/description/video":5,"./modules/faq/tabs":6,"./modules/form-validate/form":8,"./modules/reviews/slider":14,"./modules/subscriptions/card":15,"./modules/tabs/init-tabs":16,"./modules/trainers/card":18,"./modules/trainers/slider":19,"./utils/ios-vh-fix":21}],2:[function(require,module,exports){
"use strict";
...
exports.addCustomInputDisabledHandlers = void 0;
var addCustomInputDisabledHandlers = function addCustomInputDisabledHandlers() {
  var CUSTOM_INPUT_SELECTOR = '.custom-input';
  var customInputs = document.querySelectorAll(CUSTOM_INPUT_SELECTOR);
  customInputs.forEach(function (customInput) {
    if (typeof customInput.dataset.disabled === 'string') {
      var innerInput = customInput.querySelector('input');
      if (innerInput) {
...
exports.addCustomInputDisabledHandlers = addCustomInputDisabledHandlers;
...
exports.addVideoHandlers = void 0;
var addVideoHandlers = function addVideoHandlers() {
  var ROOT_SELECTOR = '.description__video';
  var BUTTON_SELECTOR = 'button';
  var HAS_VIDEO_CLASS = 'description__video--has-video';
  var root = document.querySelector(ROOT_SELECTOR);
  var button = root.querySelector(BUTTON_SELECTOR);
  button.addEventListener('click', function () {
    root.replaceChildren();
    root.classList.add(HAS_VIDEO_CLASS);
    root.innerHTML = "\n      <iframe\n        width=\"364\"\n        height: \"228\"\n        src=\"".concat(button.dataset.src, "\"\n        title=\"YouTube video player\"\n        frameborder=\"0\"\n        allow=\"accelerometer;\n        autoplay;\n        clipboard-write;\n        encrypted-media;\n        gyroscope;\n        picture-in-picture;\n        web-share\"\n        allowfullscreen\n      ></iframe>\n    ");
  }, {
    once: true
  });
};
exports.addVideoHandlers = addVideoHandlers;
...
exports.addFAQTabsHandlers = void 0;
var addFAQTabsHandlers = function addFAQTabsHandlers() {
  var ROOT_SELECTOR = '.faq__tabs';
  var BUTTON_SELECTOR = '.faq__tab-button';
  var root = document.querySelector(ROOT_SELECTOR);
  var buttons = root.querySelectorAll(BUTTON_SELECTOR);
...
exports.addFAQTabsHandlers = addFAQTabsHandlers;
...
var createReviewsSlider = function createReviewsSlider() {
  var reviewsSlider = new _swiper.default('.reviews__content', {
    grabCursor: true,
    spaceBetween: 20,
    navigation: {
...
exports.addButtonsClassByCardHover = void 0;
var addButtonsClassByCardHover = function addButtonsClassByCardHover() {
  var ROOT_SELECTOR = '.subscriptions';
  var TAB_SELECTOR = '.subscriptions__button';
  var ACTIVE_BUTTON_CLASS = 'active';
  var ACTIVE_CARD_CLASS = 'active';
  var CARD_SELECTOR = '.subscriptions__item';
  var BUTTON_SELECTOR = '.subscriptions__buy-button';
  var root = document.querySelector(ROOT_SELECTOR);
  ...
  if ('ontouchstart' in window) {
    document.body.addEventListener('click', function (event) {
      ...
      cards.forEach(function (card) {
        var button = card.querySelector(BUTTON_SELECTOR);
...
exports.addButtonsClassByCardHover = addButtonsClassByCardHover;
...
exports.addHandlersForTrainersCard = void 0;
var addHandlersForTrainersCard = function addHandlersForTrainersCard() {
  var ROOT_SELECTOR = '.trainers__items';
  var CARD_SELECTOR = '.trainers__item';
...
exports.addHandlersForTrainersCard = addHandlersForTrainersCard;
...
var initTrainersSlider = function initTrainersSlider() {
  var swiper = new _swiper.default('.trainers__content', {
    loop: true,
    grabCursor: true,
    navigation: {
...
},{"../../vendor/swiper":22}],20:[function(require,module,exports){
"use strict";
