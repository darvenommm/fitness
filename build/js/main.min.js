...
var addVideoHandlers = function addVideoHandlers() {
  ...
  var root = document.querySelector('.description__video');
...
var addButtonsClassByCardHover = function addButtonsClassByCardHover() {
  ...
  var cards = document.querySelectorAll('.subscriptions__item');
  cards.forEach(function (card) {
    var button = card.querySelector('.subscriptions__buy-button');
